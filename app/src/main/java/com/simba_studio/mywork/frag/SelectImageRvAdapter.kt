...
import com.simba_studio.mywork.databinding.SelectImageFragItemBinding
...
class SelectImageRvAdapter(val adapterCallback : AdapterCallback) : RecyclerView.Adapter<SelectImageRvAdapter.ImageHolder>(), ItemTouchMoveCallback.ItemTouchAdapter {
    ...
    class ImageHolder(private val viewBinding : SelectImageFragItemBinding, private val context : Context, private val adapter : SelectImageRvAdapter) : RecyclerView.ViewHolder(viewBinding.root) {
